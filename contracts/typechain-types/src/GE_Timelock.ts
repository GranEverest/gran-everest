...
export interface GE_TimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface GE_Timelock extends BaseContract {
  connect(runner?: ContractRunner | null): GE_Timelock;
  waitForDeployment(): Promise<this>;

  interface: GE_TimelockInterface;
